...
const paths = {
  ...
  whatsapp: (
    <>
      <path d="M3 21l1.65-4.5A8.38 8.38 0 1 1 8 19.5L3 21Z" />
      <path
        d="M16.5 14.5c-.3.8-.8 1.3-1.6 1.4-.8.1-2-.3-3.4-1.7-1.4-1.4-1.8-2.6-1.7-3.4.1-.8.6-1.3 1.4-1.6.3-.1.6 0 .8.3l.8 1.4c.2.3.1.7-.1.9l-.5.5c.3.6.8 1.1 1.4 1.4l.5-.5c.2-.2.6-.3.9-.1l1.4.8c.3.2.4.5.3.8z"
        fill="currentColor"
        stroke="none"
      />
    </>
